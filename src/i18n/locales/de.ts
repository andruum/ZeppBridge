...
export default {
  ...
  errors: {
    ...
    'err.login.timeout': 'Die Anmeldung hat zu lange gedauert. Versuche es erneut',
...
Wenn du etwas von mir brauchst (welchen Client ich nutze, wo die Datei liegt), frag einfach.`,
      ...
      apiBindNote:
        'Nur an 127.0.0.1 gebunden: nur lesend, kein Cross-Origin-Zugriff aus dem Browser, und sie gibt keine Anmeldedaten zurück. Sie stoppt, wenn du ZeppBridge beendest.',
    ...
    'App': {
      ...
      privacyLink: 'Sicherheits- und Datenschutzeinstellungen',
      ...
      timeUnknown: 'Zeit unbekannt',
      trayHint:
        'Nach dem Schließen des Fensters läuft ZeppBridge im Infobereich weiter, damit die automatische Synchronisierung aktiv bleibt.',
    ...
    'components/CoverageNotice': {
      ...
      short: (covered: number, earliest: string) =>
        `Dieser Rechner hat ${covered} Tage Daten (frühester Eintrag ${earliest}). Alles davor ist leer, weil es noch nicht aus der Cloud geholt wurde – nicht weil du damals nichts aufgezeichnet hast.`,
      syncNow: 'Jetzt synchronisieren',
    },
    ...
    'components/InsightCard': {
      ...
      comparedTo: (count: number) =>
        `Im Vergleich zu deinen eigenen ${count} letzten Läufen mit ähnlicher Distanz:`,
      confidence: {
        high: 'Gut belegt',
      ...
      driftFalling: 'Jeder Herzschlag hat dich in der zweiten Hälfte weiter getragen.',
      ...
      driftRising: 'In der zweiten Hälfte kostete dasselbe Tempo mehr Herzschläge.',
      driftSecond: 'Zweite Hälfte',
      driftSub:
        'Teilt dieses Training zeitlich in zwei Hälften und vergleicht, wie viele Herzschläge dasselbe Tempo jeweils kostete.',
    ...
    'lib/labels': {
      fallback: {
        ...
        badminton: 'Badminton',
        climb: 'Klettern',
        cycling: 'Radfahren (Outdoor)',
        elliptical: 'Crosstrainer',
        hiking: 'Wandern',
        indoor_cycling: 'Indoor-Cycling',
        indoor_run: 'Indoor-Laufen',
        ride: 'Radfahren (Outdoor)',
        rowing: 'Rudern',
        run: 'Laufen (Outdoor)',
        running: 'Laufen',
    ...
    'views/HealthCheck': {
      ...
      streamsNote:
        'Abrufen, Parsen und Schreiben sind drei Dinge, die einzeln fehlschlagen. Zu einem einzigen roten Punkt zusammengefasst, könntest du nicht sagen, ob du es erneut versuchen, neu verbinden sollst oder ob dieses Konto diesen Datenstrom schlicht nicht hat.',
    ...
    'views/HeartRateDetail': {
      ...
      restingHint: 'Die Uhr meldet einen pro Tag; je stabiler, desto besser',
      restingLabel: 'Ruheherzfrequenz',
      retry: 'Erneut versuchen',
    ...
    'views/Overview': {
      aiNodeAria: 'Übergabe an eine Cloud-KI: ChatGPT, Doubao, DeepSeek',
      ...
      heroTitleLine1: 'Deine Wearable-Daten,',
      heroTitleLine2: 'bereit für die Übergabe an eine KI',
      heroVisualAria: 'Daten erkannter Geräte fließen zu einer Cloud-KI',
      ...
      stepsGoalLine: (goal: string, percent: number) => `Ziel ${goal} · ${percent} %`,
      ...
      valueAiReady: 'KI-bereit',
      valueAiReadySub: 'Strukturiert vor der Übergabe',
      valuePrivate: 'Privat',
      valuePrivateSub: 'Rohdaten werden nie hochgeladen',
      valueSecure: 'Sicher',
      valueSecureSub: 'Daten bleiben auf diesem Rechner',
...
Antworte auf Deutsch in Markdown.`,
      ...
      decodedVerticalRatio: 'Vertikalverhältnis',
      ...
      legendFast: 'Schnell',
      legendSlow: 'Langsam',
      legendSteady: 'Gleichmäßig',
      legendWarm: 'Langsamer',
      ...
      statAverage: 'Ø',
      statFastest: 'Schnellstes',
      statMax: 'Max.',
      statMin: 'Min.',
      statSlowest: 'Langsamstes',
